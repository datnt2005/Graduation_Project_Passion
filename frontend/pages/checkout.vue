                ...
                <section class="bg-white px-6 py-4 border-b border-gray-200 space-y-4 mb-2">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Vui lòng kiểm tra thông tin trước khi hoàn tất đơn
                                hàng</p>
                        </div>
                                ...
                                <form v-else class="space-y-6 text-xs text-gray-700 max-w-md">
                                    <label v-for="method in paymentMethods" :key="method.id" class="cursor-pointer"
                                        ...
                                        <template v-if="method.name === 'VNPAY'">
                                            <span class="text-xs text-gray-400 ml-9">Quét Mã QR từ ứng dụng ngân
                                                hàng</span>
                                        </template>
                        ...
                        <div class="lg:col-span-1 space-y-2">
                                ...
                                <div class="flex items-start justify-between mb-4">
                                    <div class="flex-1">
                                        <div class="flex items-center mb-2">
                                            ...
                                            <span class="text-[13px] text-gray-600 ml-2">(Đã chọn {{
                                                selectedDiscounts.length }}/2)</span>
                                        </div>
                                        <div v-if="selectedDiscounts.length"
                                            ...
                                            <div v-for="discount in selectedDiscounts" :key="discount.id"
                                                ...
                                                <!-- Nút X đỏ tròn ở góc trên bên phải -->
                                                ...
                                                <div>
                                                    <p class="text-sm font-semibold text-green-600">{{ discount.name }}
                                                    </p>
                                    ...
                                    <span class="text-[14px] text-gray-500 ml-4 self-start whitespace-nowrap">Có thể
                                        chọn 2</span>
                                </div>
                                ...
                                <div v-if="showDiscountModal"
                                    ...
                                    <div class="bg-white rounded-[8px] shadow-xl w-full max-w-2xl p-6 relative">
                                        ...
                                        <div class="space-y-6 max-h-[450px] overflow-y-auto">
                                            <div>
                                                <h3 class="text-sm font-medium text-gray-700 mb-2">Mã giảm phí vận
                                                    chuyển</h3>
                                                    ...
                                                    <div v-for="discount in discounts.filter(d => d.discount_type === 'shipping_fee')"
                                                        ...
                                                        <div class="flex justify-between items-center">
                                                            <div>
                                                                ...
                                                                <p class="text-[11px] text-gray-400 mt-1">HSD: {{
                                                ...
                                                <div v-else class="text-gray-500 text-sm italic mt-2">Không có mã phù
                                                    hợp</div>
                                            </div>
                                            <div>
                                                <h3 class="text-sm font-medium text-gray-700 mb-2">Mã giảm giá sản phẩm
                                                </h3>
                                                <div v-if="discounts.filter(d => d.discount_type !== 'shipping_fee').length"
                                                    class="space-y-3">
                                                    <div v-for="discount in discounts.filter(d => d.discount_type !== 'shipping_fee')"
                            ...
                            <section class="bg-white rounded-lg p-4 text-xs text-gray-700 border border-[#E6E8F0]">
                                <label class="flex items-start gap-2 cursor-pointer">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-gray-400 text-[11px]">Passion Trading chỉ xuất hoá đơn điện
                                            tử</span>
                                    </div>
                                </label>
                            </section>
                            ...
                            <section
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <NuxtLink to="/cart" class="text-blue-600 text-sm font-medium hover:underline">Thay
                                        đổi</NuxtLink>
                                </div>
                                <div class="space-y-3">
                                    <div class="text-sm">
                                        {{ cartItems.length }} sản phẩm.
                                        <NuxtLink to="/cart" class="text-blue-600 hover:underline">Xem chi tiết
                                        </NuxtLink>
                                    </div>
                                    <hr />
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-green-600">- {{ formatPrice(getShippingDiscount(total)) }}
                                            đ</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-[14px]">Giảm giá</span>
                                        <span class="text-green-600">- {{ formatPrice(calculateDiscount(total)) }}
                                            đ</span>
                                    </div>
                                    <div
                                    ...
                                    <p class="text-xs text-gray-500 italic text-right mt-1 leading-snug">
                                        (Giá đã bao gồm thuế GTGT, phí đóng gói, phí vận chuyển và chi phí phát sinh
                                        khác)
                                    </p>
                                </div>
                                <div class="pt-2">
...
const selectPromotion = async (promotion) => {
    ...
    // Optionally, map promotion to a discount and apply it
...
const addNewCard = () => {
    ...
    // Implement card addition logic here (e.g., open modal, redirect to payment gateway)
};
