          ...
          <div class="flex-1 space-y-4">
            ...
            <div class="flex justify-between items-center bg-white border rounded-sm p-4">
              <div class="flex items-center space-x-4">
                <img
                  src="https://cf.shopee.vn/file/7bdab1db90b84a85844658f0938a34d1_tn"
                  alt="Shop avatar"
...
const product = {
  ...
  discountPercent: 90,
  fullDescription: `
    Samsung note20 ultra 5G ram 12G ổ cứng 256 G. Máy đầy đủ tính năng. Ngoại hình đẹp 99%. Màn chính kim.
    Giá chỉ 5tr6, với các trạng thái như mới, chưa trầy xước, chưa tróc sơn, vân tay.
