<template>
  <main class="bg-white p-8 rounded shadow max-w-7xl mx-auto mt-6">
    ...
    <div class="text-center mb-10">
      ...
      <NuxtLink href="/seller/register" class="inline-block mt-6 bg-[#1BA0E2] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#1591cc] transition">
        Đăng ký ngay
      </NuxtLink>
    </div>
    ...
    <div class="mt-16 text-center">
      <h2 class="text-2xl font-bold mb-4 text-[#1BA0E2]">Chỉ 3 bước để bắt đầu bán hàng</h2>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-left mt-6">
        ...
        <div class="p-4 bg-[#E6F4FB] rounded-lg">
          <h3 class="font-semibold mb-1 text-[#1BA0E2]">2. Đăng sản phẩm bạn yêu thích</h3>
          <p class="text-sm text-gray-600">Tạo gian hàng riêng và chia sẻ đam mê thông qua sản phẩm.</p>
        </div>
        <div class="p-4 bg-[#E6F4FB] rounded-lg">
          <h3 class="font-semibold mb-1 text-[#1BA0E2]">3. Bán hàng – kiếm thu nhập</h3>
