<template>
  <main class="bg-[#F5F5FA] py-5">
    <div class="bg-white p-8 rounded shadow max-w-7xl mx-auto ">
      <!-- Banner -->
      <div class="text-center mb-10">
        <h1 class="text-3xl font-bold text-[#1BA0E2]">Bán hàng cùng Passion</h1>
        <p class="mt-2 text-gray-600">Biến đam mê của bạn thành thu nhập ổn định với nền tảng thương mại điện tử
          Passion.</p>
        <img src="/images/seller.png" alt="Bán hàng cùng Passion"
          class="mx-auto mt-6 rounded-lg shadow-md w-full max-w-3xl">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm mt-1">Kết nối với cộng đồng người tiêu dùng yêu thích sản phẩm độc đáo, sáng
            tạo.</p>
        </div>
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm mt-1">Đội ngũ Passion sẵn sàng đồng hành cùng bạn trên từng bước phát triển.
          </p>
        </div>
        <div class="text-center">
          ...
          <p class="text-gray-600 text-sm mt-1">Quản lý đơn hàng, vận chuyển và thanh toán dễ dàng – tất cả trong một.
          </p>
        </div>
      </div>
