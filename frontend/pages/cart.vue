    ...
    >
      ...
      <div class="flex-1">
        ...
        >
          ...
          <div class="flex-1 space-y-4">
            ...
            <div class="border border-[#f8b77b] rounded-md bg-white">
              <div
                class="flex items-center px-4 py-2 border-b border-[#f8b77b] bg-[#ffe0b3]"
              >
              ...
              <!-- Fake product row -->
              <div
                class="grid grid-cols-[40px_280px_1fr_120px_120px_120px_40px] items-center px-4 py-4 gap-2"
              >
        ...
        <template v-else>
          ...
          >
            ...
            <div class="text-center">
              <button
                ...
                @click="showRemoveSelectedDialog"
          ...
          <!-- Store sections -->
          <div
            v-for="store in cart.stores"
            :key="store.seller_id"
            class="mb-4 border border-[#f8b77b] rounded-md"
          >
            <!-- Store header -->
            <div
            ...
            >
              ...
              >
                <input
                  type="checkbox"
                  :checked="storeSelections[store.seller_id]"
                ...
                <NuxtLink
                  :to="store.store_url"
                  class="text-[#222] hover:underline"
                  >{{ store.store_name }}</NuxtLink
                >
                <i class="fas fa-chevron-right text-xs text-[#666]"></i>
              </label>
              <button
                class="text-[#007aff] text-[13px] hover:underline"
              ...
              <div class="md:hidden flex items-start space-x-3 p-3 bg-white">
                ...
                <div class="flex-1">
                  ...
                  <!-- <div class="flex items-center space-x-2 mt-1">
                    <span
                      class="bg-green-100 text-green-700 text-[11px] px-2 py-0.5 rounded"
                    >
                      Hàng Việt
                    </span>
                  </div> -->
                  <div class="flex items-center justify-between mt-2">
                    ...
                    <div class="flex items-center border rounded">
                      <button
                        ...
                        "
                        class="w-7 h-7 text-lg font-semibold border-r"
              ...
              >
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div class="flex flex-col text-[13px] leading-tight">
                    <NuxtLink
                      ...
                      class="text-[#222] font-semibold hover:underline"
                    >
                      {{ item.product.name }}
                    </NuxtLink>
                ...
                <div class="flex justify-center items-center space-x-1">
                  ...
                  <input
                    ...
                    "
                    :disabled="loading"
                    class="w-10 h-6 border-t border-b text-center text-sm font-semibold"
                  />
                  <button
                    @click="
                      updateQuantityWithValidation(item.id, item.quantity + 1)
                ...
                <!-- Thành tiền -->
                <div
                  class="text-right text-[#ff3b30] font-semibold text-[14px]"
                >
                  {{
                    formatPrice(
                ...
                <div class="text-center text-[#999]">
                  <button
                    @click="showRemoveItemDialog(item.id)"
