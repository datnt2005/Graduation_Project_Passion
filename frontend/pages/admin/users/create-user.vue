            ...
            <div class="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-4">
              <section class="space-y-4">
                <div class="space-y-2">
                  ...
                  <div class="mt-4">
                    <label for="user-password" class="block text-sm text-gray-700 mb-1">Mật khẩu</label>
  ...
  try {
    ...
    if (data.success) {
      ...
      if (data.errors) {
        ...
        showSuccessNotification(data.message || 'Có lỗi xảy ra khi tạo người dùng')
      }
    }
  } catch (error) {
    console.error('Error:', error)
    showSuccessNotification('Có lỗi xảy ra khi tạo người dùng')
  } finally {
    loading.value = false
  }
}
