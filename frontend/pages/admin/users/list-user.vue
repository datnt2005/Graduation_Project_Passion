  ...
  <div class="bg-gray-100 text-gray-700 font-sans">
    <div class="max-w-full overflow-x-auto">
      ...
      <div class="bg-white px-4 py-4 flex items-center justify-between border-b border-gray-200">
        ...
        <button
          @click="router.push('/admin/users/create-user')"
      ...
      <div class="bg-gray-200 px-4 py-3 flex flex-wrap items-center gap-3 text-sm text-gray-700 border-t border-gray-300">
        ...
        <button
          ...
          :disabled="!selectedAction || selectedUsers.length === 0 || loading"
          :class="[(!selectedAction || selectedUsers.length === 0 || loading) 
      ...
      <table class="min-w-full border-collapse border border-gray-300 text-sm">
        ...
        <tbody>
          <tr v-for="user in filteredUsers" :key="user.id" :class="{'bg-gray-50': user.id % 2 === 0}" class="border-b border-gray-300">
...
const applyBulkAction = async () => {
  ...
  if (selectedAction.value === 'delete') {
    ...
    // Set vai trò hàng loạt
    let role = ''
    if (selectedAction.value === 'set_admin') role = 'admin'
    // if (selectedAction.value === 'set_editor') role = 'editor'
