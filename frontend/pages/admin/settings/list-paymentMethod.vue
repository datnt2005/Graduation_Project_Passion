  ...
  <div class="bg-gray-100 text-gray-700 font-sans min-h-screen flex">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex-shrink-0 hidden md:block">
      <nav class="py-6 px-4 space-y-2">
        ...
        <ul class="space-y-1">
          <li>
            <router-link to="/admin/settings/list-paymentMethod" class="block px-3 py-2 rounded-md font-medium"
              :class="$route.path.includes('list-paymentMethod') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-50'">
              <i class="fa fa-credit-card mr-2"></i> Quản lý phương thức thanh toán
            </router-link>
          </li>
          <li>
            <router-link to="/admin/settings/list-address" class="block px-3 py-2 rounded-md font-medium"
              :class="$route.path.includes('list-address') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-50'">
              <i class="fa fa-map-marker-alt mr-2"></i> Quản lý địa chỉ
            </router-link>
          </li>
          <li>
            <router-link to="/admin/settings/list-shipping" class="block px-3 py-2 rounded-md font-medium"
              :class="$route.path.includes('list-shipping') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-50'">
              <i class="fa fa-shipping-fast mr-2"></i> Quản lý vận chuyển
            </router-link>
          </li>
          <li>
            <router-link to="/admin/settings/list-other" class="block px-3 py-2 rounded-md font-medium"
              :class="$route.path.includes('list-other') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-50'">
