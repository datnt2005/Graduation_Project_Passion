        ...
        >
          ...
          >
            ...
            <p class="text-sm text-center opacity-80">
              Tham gia ngay để trải nghiệm những tính năng tuyệt vời.
            </p>
            <img
              src="/images/img-form-removebg-preview.png"
              alt="Welcome Image"
          ...
          <div class="w-full md:w-1/2 p-6 sm:p-8 relative">
            ...
            <div class="flex justify-between items-center mb-6">
              <h2
                class="text-2xl font-bold text-[#1BA0E2] font-inter tracking-tight"
              >
            ...
            >
              <div v-if="!isLogin" class="relative">
                <i
                  class="fas fa-user absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 peer-focus:text-[#1BA0E2] peer-focus:scale-110"
                ></i>
                <input
                  v-model="form.name"
                  type="text"
              ...
              <div class="relative">
                <i
                  class="fas fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 peer-focus:text-[#1BA0E2] peer-focus:scale-110"
                ></i>
                <input
                  v-model="form.email"
                  type="email"
              ...
              <div class="relative">
                <i
                  class="fas fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 peer-focus:text-[#1BA0E2] peer-focus:scale-110"
                ></i>
                <input
              ...
              <div v-if="!isLogin" class="relative">
                <i
                  class="fas fa-shield-alt absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 peer-focus:text-[#1BA0E2] peer-focus:scale-110"
                ></i>
                <input
              ...
              <div v-if="!isLogin" class="relative">
                <i
                  class="fas fa-phone absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 peer-focus:text-[#1BA0E2] peer-focus:scale-110"
                ></i>
                <input
                  v-model="form.phone"
                  type="text"
            ...
            <form
              v-if="showVerifyEmailForm && !showOtp"
              @submit.prevent="sendVerificationRequest"
              class="space-y-4 border-t pt-5 mt-6"
            >
              <p class="text-sm text-gray-600">
                Bạn cần xác minh email để tiếp tục. Nhập email của bạn:
              </p>
              <div class="relative">
                <i
                  class="fas fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 peer-focus:text-[#1BA0E2] peer-focus:scale-110"
            ...
            <form
              ...
              class="space-y-5 border-t pt-5 mt-6"
            >
              <h2 class="text-xl font-bold text-[#1BA0E2] font-inter">
                Xác minh OTP
              </h2>
              <p class="text-sm text-gray-600">
                Vui lòng kiểm tra email và nhập mã OTP để xác minh tài khoản.
              </p>

              <div class="relative">
                <i
                  class="fas fa-key absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 transition-all duration-300 peer-focus:text-[#1BA0E2] peer-focus:scale-110"
                ></i>
                <input
                  v-model="otp"
                  type="text"
              ...
              >
                <template v-if="resendCountdown > 0"
                  >Gửi lại mã sau {{ resendCountdown }} giây</template
                >
            ...
            >
              ...
              >
                <span v-if="isSending"
                  ><i class="fas fa-spinner fa-spin mr-2"></i>Đang gửi...</span
                >
            ...
            >
              ...
              <div class="relative">
                <i
                  class="fas fa-key absolute left-4 top-1/2 -translate-y-1/2 text-gray-400"
                ></i>
                <input
              ...
              >
                <span v-if="isResetting"
                  ><i class="fas fa-spinner fa-spin mr-2"></i>Đang đặt
                  lại...</span
                >
      ...
      try {
        ...
        if (res.ok && data.data) {
          window.dispatchEvent(
            new CustomEvent("loginSuccess", { detail: data.data })
          );
...
const submitForm = async () => {
  ...
  try {
    ...
    if (
      ...
      toast(
        "warning",
        "Tài khoản chưa được xác minh, vui lòng xác minh trước khi đăng nhập"
      );
...
const sendForgotEmail = async () => {
  ...
  try {
    const res = await axios.post(`${api}/send-forgot-password`, {
