      ...
      <div class="w-3/4 bg-white shadow-md h-full p-4 relative">
        ...
        <div class="space-y-4 mt-10 text-sm">
          ...
          <a href="#" class="block text-gray-700 hover:text-blue-600"><font-awesome-icon
              :icon="['fas', 'cart-shopping']" /> Giỏ hàng</a>
          ...
          <a href="#" class="block text-gray-700 hover:text-blue-600" @click.prevent="openLogin"><font-awesome-icon
              :icon="['fas', 'right-to-bracket']" /> Đăng nhập</a>
          <a href="#" class="block text-gray-700 hover:text-blue-600" @click.prevent="openRegister"><font-awesome-icon
              :icon="['fas', 'plus']" /> Đăng ký</a>
        </div>
      </div>
    </div>
