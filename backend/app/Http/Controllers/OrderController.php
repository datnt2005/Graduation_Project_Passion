    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $order->update([
                ...
                'final_price' => $request->final_price, // ✅ frontend gửi vào chính xác
            ]);
            ...
            Payment::create([
                ...
                'amount' => $request->final_price, // ✅ chính xác theo order
                'status' => 'pending'
            ]);
            ...
            // Load lại dữ liệu order kèm quan hệ
            $order->load([
                'orderItems.product',
