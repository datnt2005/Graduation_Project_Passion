...
class SellerController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'phone_number.regex' => 'Số điện thoại không hợp lệ. Vui lòng nhập đúng định dạng Việt Nam.',
            'bio' => 'nullable|string',
            'cccd_front' => 'sometimes|file|mimes:jpg,jpeg,png|max:4096',
            'cccd_back' => 'sometimes|file|mimes:jpg,jpeg,png|max:4096',
            ...
            'phone_number.regex' => 'Số điện thoại không hợp lệ. Vui lòng nhập đúng số di động Việt Nam 10 chữ số.',
